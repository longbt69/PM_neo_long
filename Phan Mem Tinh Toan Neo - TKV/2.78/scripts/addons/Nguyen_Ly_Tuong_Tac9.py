...
def tinh_toan_NEM():
	...
	height = v * bpy.data.scenes[nguyenLy_4].TrongLuongTheTichDatDa_NL4
	bpy.data.scenes[nguyenLy_4].TrongLuong_KhoiNem_Noc_NL4 = height

	# Hệ số an toàn Khố Nêm nóc
	hs_at = bpy.data.scenes[nguyenLy_4].SoLuongNeoGiuKhoiNem_NL4 * bpy.data.scenes[
		nguyenLy_4].KhaNangChiuLuc1ThanhNeo_NL4 / height
